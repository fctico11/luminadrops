...
/** The merged "What's Waiting Inside" — Club Manual photo/description
 * followed by the rest of the items grid, all visible at once (the "See
 * What's Inside" button up in the buy box just scrolls down to here).
