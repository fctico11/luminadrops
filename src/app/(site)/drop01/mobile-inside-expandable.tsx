...
/** Mobile's merged "What's Waiting Inside" — shows just the Club Manual
...
export default function MobileInsideExpandable({ content, isAdmin }: Props) {
  ...
  return (
    <div>
      ...
      <div className="relative mx-auto mt-8 aspect-square w-[calc(50%-0.5rem)] overflow-hidden border border-[#3a352e]">
        <EditableImage
          file="drop01"
          field="manualImage"
      ...
      <button
        ...
        className={`${expanded ? "" : "soft-button-glow"} mt-6 inline-flex items-center justify-center border border-[#6f695c]/80 px-5 py-2.5 text-[11px] font-medium tracking-[0.15em] text-[#e9e1cd] transition-all duration-300 hover:border-[#cfc0a0] hover:bg-white/[0.04] hover:text-[#fff6e0]`}
      >
      ...
      {expanded && (
        <>
          <div className="mt-8 grid grid-cols-2 gap-x-4 gap-y-8 text-left">
